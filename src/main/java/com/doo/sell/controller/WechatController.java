...
import com.doo.sell.config.ProjiectUrlConfig;
...
public class WechatController {
    ...
    @Autowired
    private ProjiectUrlConfig projiectUrlConfig;

    @RequestMapping("/authorize")
    public String authorize(@RequestParam("returnUrl") String returnUrl){
        String url = projiectUrlConfig.getWechatMpAuthorize() + "/sell/wechat/userInfo";
